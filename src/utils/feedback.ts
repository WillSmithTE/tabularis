 ...
 * is EVERYTHING that is sent: the message the user typed and a static app
 * identifier + version. No connection names, no database names, no queries,
 * no window title, no URLs, no user or machine identifiers. If a future
 * change adds a field here, it shows up in this diff.
 */
